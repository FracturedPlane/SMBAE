...
class DeepCACLADV(DeepCACLA):
    
    def __init__(self, n_in, n_out, state_bounds, action_bounds, reward_bound, settings_):

        super(DeepCACLADV,self).__init__(n_in, n_out, state_bounds, action_bounds, reward_bound, settings_)
        ...
        #                                    self._rms_epsilon)
        #updates_B = rmsprop(lossB, paramsB, self._learning_rate, self._rho,
        #                                    self._rms_epsilon)
        # TD update
        ...
        self._trainActor = theano.function([], [self._q_valsA], updates=actionUpdates, givens=actGivens)
        self._trainActorB = theano.function([], [self._q_valsB], updates=actionUpdatesB, givens=actGivens)
